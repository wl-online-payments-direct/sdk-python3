...
htmlhelp_basename = 'direct-sdk-python3doc'
...
latex_documents = [
    (master_doc, 'direct-sdk-python3.tex', 'direct-sdk-python3 Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'direct-sdk-python3', 'direct-sdk-python3 Documentation',
     [author], 1)
]
